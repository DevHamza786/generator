...
return new class extends Migration
{
    ...
    {
        Schema::create('generator_write_logs', function (Blueprint $table) {
            $table->id();
            ...
            $table->timestamp('write_timestamp');
            $table->timestamps();

            $table->index(['generator_id', 'write_timestamp']);
        });
    }
    ...
    {
        Schema::dropIfExists('generator_write_logs');
    }
};
